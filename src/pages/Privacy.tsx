  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      <main className="flex-1 px-6 py-12 md:px-12 md:py-16 max-w-4xl mx-auto w-full">
        <div className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-2 text-gray-900 font-['DM_Sans']">Privacy Policy</h1>
        ...
        <section className="mb-10">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 font-['DM_Sans']">1. Introduction</h2>
        ...
        <section className="mb-10">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 font-['DM_Sans']">2. Information We Collect</h2>
          <p className="text-base md:text-lg leading-7 text-gray-700 mb-4 font-['DM_Sans']">
        ...
        <section className="mb-10">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 font-['DM_Sans']">3. How We Use Your Data</h2>
          <p className="text-base md:text-lg leading-7 text-gray-700 mb-4 font-['DM_Sans']">We use your data to:</p>
          ...
          <p className="text-base md:text-lg leading-7 text-gray-700 font-['DM_Sans']">We will never sell your data.</p>
        </section>

        <div className="border-t border-gray-200 mb-8" />

        <section className="mb-10">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 font-['DM_Sans']">4. Data Protection and Security</h2>
          <p className="text-base md:text-lg leading-7 text-gray-700 mb-4 font-['DM_Sans']">
        ...
        <section className="mb-10">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 font-['DM_Sans']">5. Your Rights (Under RA 10173)</h2>
          <p className="text-base md:text-lg leading-7 text-gray-700 mb-4 font-['DM_Sans']">You have the right to:</p>
          <ul className="list-disc list-outside ml-6 space-y-2 text-base md:text-lg leading-7 text-gray-700 mb-4 font-['DM_Sans']">
          ...
          <p className="text-base md:text-lg leading-7 text-gray-700 font-['DM_Sans']">
            To exercise these rights, contact <strong><a href="mailto:typidapp@gmail.com" className="text-[#0a7a94] hover:underline">typidapp@gmail.com</a></strong>.
          </p>
        </section>
        ...
        <section className="mb-10">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 font-['DM_Sans']">6. Data Retention and Account Deletion</h2>
        ...
        <section className="mb-10">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 font-['DM_Sans']">7. Children's Privacy</h2>
          <p className="text-base md:text-lg leading-7 text-gray-700 font-['DM_Sans']">
        ...
        <section className="mb-10">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 font-['DM_Sans']">8. Data Storage and Transfers</h2>
          <p className="text-base md:text-lg leading-7 text-gray-700 font-['DM_Sans']">
        ...
        <section className="mb-10">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 font-['DM_Sans']">9. Third-Party Services</h2>
          <p className="text-base md:text-lg leading-7 text-gray-700 mb-4 font-['DM_Sans']">We currently use:</p>
          <ul className="list-disc list-outside ml-6 space-y-2 text-base md:text-lg leading-7 text-gray-700 mb-4 font-['DM_Sans']">
        ...
        <section className="mb-10">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 font-['DM_Sans']">10. Analytics</h2>
          <p className="text-base md:text-lg leading-7 text-gray-700 font-['DM_Sans']">
        ...
        <section className="mb-10">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 font-['DM_Sans']">11. Updates to This Policy</h2>
          <p className="text-base md:text-lg leading-7 text-gray-700 font-['DM_Sans']">
        ...
        <section className="mb-10">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 font-['DM_Sans']">12. Contact Us</h2>
