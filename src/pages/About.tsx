  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      <main className="flex-1 px-6 py-12 md:px-12 md:py-16 max-w-4xl mx-auto w-full">
        <div className="mb-8">
          <h1 className="text-4xl md:text-5xl  mb-2 text-gray-cool-950">A Friendship Turned Creative Collaboration</h1>
        </div>
        ...
        <section className="mb-10">
          ...
          <p className="text-md-regular text-gray-cool-700 mb-6">
          Meanwhile, Warren, who had relocated to Davao City to pursue his career as a UI/UX Designer, shared his expertise in branding, user experience, and illustration. Together, they brought Typid to life—a mobile app designed to track savings, income, and budgets as a hobby project.
          </p>
          <p className="text-md-regular text-gray-cool-700 mb-6">
