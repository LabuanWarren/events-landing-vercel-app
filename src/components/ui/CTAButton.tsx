...
export const CTAButton: React.FC<CTAButtonProps> = ({
  ...
  return (
    <a
      href={href}
      aria-label={label}
      className="rounded-xl h-[64px] gap-[40px] flex flex-row justify-between items-center px-3 py-[2px] bg-brand-gradient transition-all duration-350 shadow-[0_6px_20px_rgba(28,221,244,0.3)] hover:translate-y-[-5px] hover:shadow-[0_10px_30px_rgba(28,221,244,0.45)] active:translate-y-0 active:shadow-[0_4px_15px_rgba(28,221,244,0.25)] hover:brightness-110 "
    >
      <div className="flex flex-row justify-start items-end p-[4px] h-[48px]">
        <span className="text-md-medium text-gray-cool-950">
          {label}
        </span>
      </div>

      {!hideIcon && (
        <div className="flex justify-end h-[48px] pt-[4px] ">
...
export const CTAButtonSmall: React.FC<CTAButtonProps> = ({
  ...
  return (
    <a
      href={href}
      aria-label={label}
      className="h-[46px] rounded-xl flex flex-row justify-between items-center px-4 bg-brand-gradient transition-all duration-250 shadow-[0_6px_20px_rgba(28,221,244,0.3)] hover:translate-y-[-3px] hover:shadow-[0_10px_30px_rgba(28,221,244,0.45)] active:translate-y-0 active:shadow-[0_4px_15px_rgba(28,221,244,0.25)] hover:brightness-110"
    >
